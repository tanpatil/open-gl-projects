...
void MySetupLights()
{
    ...
    myLights[1].AmbientColor.Set(0.4, 0.4, 0.4);    // Yellow color
    myLights[1].DiffuseColor.Set(0.7, 0.7, 0.7);    // Yellow
    myLights[1].SpecularColor.Set(0.7, 0.7, 0.7);   // White
    myLights[1].IsEnabled = true;                     // BE SURE TO ENABLE YOUR LIGHTS

    // Third light (light #2)
    myLights[2].AmbientColor.Set(0.4, 0.4, 0.4);    // Yellow color
    myLights[2].DiffuseColor.Set(0.5, 0.5, 0.5);      // Very light gray
    myLights[2].SpecularColor.Set(0.8, 0.8, 0.8);   // Very light gray
